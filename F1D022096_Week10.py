...
class ManajemenBuku(QMainWindow):
    ...
    def initDataBukuTab(self):
        ...
        formLayout.addWidget(QLabel("Judul:"))
        formLayout.addWidget(self.judulInput)
        formLayout.addWidget(QLabel("Pengarang:"))
        formLayout.addWidget(self.pengarangInput)
        formLayout.addWidget(QLabel("Tahun:"))
        formLayout.addWidget(self.tahunInput)
        ...
        nimLabel = QLabel("F1D022096")
        nimLabel.setAlignment(Qt.AlignRight | Qt.AlignVCenter)
        bottomLayout.addStretch()
        bottomLayout.addWidget(nimLabel)
